...
namespace AssistenteVendas.Infra.Data.Repositories
{
    public abstract class BaseRepository<TEntity> : IBaseRepository<TEntity> where TEntity : class
    {
        ...
        )
        {
            ...
            _transactionService.SetDbContext(_dbContext);
        ...
        {
            var query = string.IsNullOrEmpty(filtro) ? DbContextSet : DbContextSet;
        ...
        private EntityEntry GetTraked(TEntity entity)
        {
            ...
            {
                var trackerEntries =  _dbContext.ChangeTracker.Entries().FirstOrDefault(r =>
        ...
        public async Task<int> SaveChanges(CancellationToken cancellationToken = default) => await _dbContext.SaveChangesAsync(cancellationToken);
